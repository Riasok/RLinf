...
LOG_DIR="${ROOT}/logs/20260828-libero_long_ppo_gpu67_gen10_exec5"
...
export RAY_TMPDIR="/tmp/rlp67"
export TMPDIR="/tmp/tp67"
unset RAY_ADDRESS
...
exec "${ROOT}/.venv/bin/python" examples/embodiment/train_embodied_agent.py \
  ...
  --config-name libero_10_ppo_pi05_gpu67_gen10_exec5_100steps \
